...
export function MerchantSidebar() {
  ...
  return (
    <aside className="flex h-full w-56 flex-col border-r border-[#5e1914] bg-black" style={{ borderRightWidth: "1px" }}>
      <div className="flex h-14 items-center border-b border-[#5e1914]/30 px-4">
